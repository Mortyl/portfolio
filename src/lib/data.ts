...
export const projects: Project[] = [
  ...
  },
  {
    ...
    caseStudy: {
      ...
      decisions:
        "The key decision was building a file-based knowledge system rather than relying on Claude's training data alone. PoE2 is in Early Access and Claude's training data contains a lot of PoE1 knowledge, so without grounding, the AI confidently gives wrong answers. Curating the knowledge base manually means every piece of information the AI uses has been verified against the current patch, keeping responses accurate as the game continues to change.",
      learned:
  ...
  },
  {
    ...
    caseStudy: {
      ...
      problem: "Most task managers don't show live updates without refreshing, so collaborating with a team means constantly missing changes. I wanted to build something where changes are reflected instantly across all connected users.",
